...
class CategoriesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('actions', 'dashboard.basic_information.categories.buttons.actions')
            ->addColumn('checkbox', 'dashboard.basic_information.categories.buttons.checkbox')
            ->addColumn('level', 'dashboard.basic_information.categories.buttons.level')
    ...
    {
        return Category::query()->where(function($q){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'name'  => 'code',
                'data'  => 'code',
                'title' => trans('admin.category_code'),
            ],[
				'name'  => 'name',
				'data'  => 'name',
