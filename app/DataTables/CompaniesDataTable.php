...
class CompaniesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('actions', 'dashboard.basic_information.companies.buttons.actions')
            ->addColumn('checkbox', 'dashboard.basic_information.companies.buttons.checkbox')
            ->addColumn('level', 'dashboard.basic_information.companies.buttons.level')
    ...
    {
        return Company::query()->where(function($q){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'name'  => 'code',
                'data'  => 'code',
                'title' => trans('admin.company_code'),
            ],[
				'name'  => 'name',
				'data'  => 'name',
