...
class ProductsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('actions', 'dashboard.basic_information.products.buttons.actions')
            ->addColumn('checkbox', 'dashboard.basic_information.products.buttons.checkbox')
            ->addColumn('level', 'dashboard.basic_information.products.buttons.level')
    ...
    {
        return \App\Models\Product::query()->with(['company','category'])->where(function($q){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
				...
				'name'  => 'purchase_price',
				'data'  => 'purchase_price',
				'title' => trans('admin.purchase_price'),
			], [
				'name'  => 'sale_price',
				'data'  => 'sale_price',
