...
class UsersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('actions', 'dashboard.users.buttons.actions')
            ->addColumn('checkbox', 'dashboard.users.buttons.checkbox')
            ->addColumn('level', 'dashboard.users.buttons.level')
    ...
    {
        return User::query()->with('job')->where(function($q){
