...
class JobsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('actions', 'dashboard.basic_information.jobs.buttons.actions')
            ->addColumn('checkbox', 'dashboard.basic_information.jobs.buttons.checkbox')
            ->addColumn('level', 'dashboard.basic_information.jobs.buttons.level')
    ...
    {
        return Job::query()->where(function($q){
